...
!      Comment out the flip sign of theta 
!      do k=kb-1,ke+1
!        do j = jb-1,je+1
!          bx(1  ,j,k)=bx(2  ,j,k)
!          by(1  ,j,k)=by(2  ,j,k)
...
!
      ...
      use parameter_mod
      use MESH2D
      double precision:: tenx,teny,tenz,xj,yj,zj,bxx,byy,bzz,btot,tjdotb,curr_tot
...
!
      ...
      double precision:: v_limit,eps2,rx0,ry0,rz0,rrat,sqrr,outer_radius,myranf,twopi,fluxran,vxa,vyz,vza,vmag,vy_tmp,d_ranf
...
!     Nonuniform mesh
      ...
      CALL XREALBCC_PACK_B(Bdipole_x,Bdipole_y,Bdipole_z,1,NX,NY,NZ)
